    ...
    state = {
      ...
      selectedMonthEvents: [
        ...
        },
        {
          ...
          date: moment(`${moment().year()}-${moment().month() + 1}-29`),
        },
      ],
      showEvents: false
    };
