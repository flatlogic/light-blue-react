  ...
  render() {
    return (
      <div className={s.root}>
        <h2 className="page-title">Charts
            ...
            >
              <div>
                <p className="fs-mini text-muted mb-lg">
                  Rickshaw provides the elements you need to create interactive graphs: renderers,
                  legends, hovers, range selectors, etc. You put the pieces together.
                  It&apos;s all based on <span className="fw-semi-bold">d3</span> underneath,
                  so graphs are drawn with standard SVG and styled with CSS.
        ...
        <Row>
          <Col lg={7} xl={8} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  This project is an attempt to build re-usable charts and chart components for
                  <span className="fw-semi-bold">d3.js</span> without taking away the power that
                  d3.js gives you.
                </p>
                <div>
          ...
          <Col lg={5} xl={4} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  This is a very young collection of components, with the goal of keeping
                  these components very customizeable.
                </p>
                <div>
        ...
        <Row>
          <Col lg={6} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  Good-looking charts shouldn&apos;t be difficult. The public API is terribly
                  simple. It&apos;s just one function: <code>Morris.Line(options)</code>, where
                  options is an object containing some of the following configuration options.
                </p>
            ...
            >
              <div className="clearfix">
                ...
                <p className="fs-mini text-muted">
                  ...
                  very easy to implement, scale to the resolution of the display of the
            ...
            >
              <div>
                ...
                <p className="fs-mini text-muted">
                  ...
                  disk partitions, etc. This really couldn&apos;t be easier. Create a Donut chart
                  using <code>Morris.Donut(options)</code>, with only few options.
                </p>
              </div>
            </Widget>
          </Col>
