      ...
      <div className={s.root}>
        ...
        <div className="btn-toolbar justify-content-between">
          <div className="d-inline-flex">
            ...
            <Button className="ml-1">All Time</Button>
          </div>
          <ButtonGroup>
        ...
        <Row>
          <Col xl={9}>
                ...
                <Row>
                  <Col md={9}>
                    <h4 className={s.searchResultItemHeading}>
                      ...
                      <span className="badge badge-pill badge-danger fw-normal">Best Deal!</span>
                    </h4>
                    <p className={s.info}>
            ...
            <div className="text-center">
              <Pagination className="pagination-search-result my-3">
          ...
          <Col xl={3}>
            ...
            <p className="text-muted">Listed content is categorized by the following groups:</p>
