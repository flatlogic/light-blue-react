...
class Live extends React.Component {
  ...
  render() {
    return (
      <div>
        <h2 className="page-title">Grid - <span className="fw-semi-bold">Live</span>
        ...
        <Row>
          ...
          <Col lg={7} xs={12}>
            ...
            >
              <div>
                <p>
                  Specially for Light Blue 2.1 we have developed a plugin that allows to
                  easily implement basic widget functions that lots of our customers have
                  requested. The plugin is called <strong>Widgster</strong>. For now it
                  has the following essential widget features:
                </p>
                <ul className="text-list">
                  <li><strong>Collapse/Expand</strong>
                    ` - all widgets can be collapsed to fill only header&#39;s vertical space;`
                  </li>
                  <li><strong>Close</strong> - closable. Any widget may be removed by
                    clicking the close btn;
                  </li>
                  <li><strong>Full Screen</strong> - an option to make widget fill the
                    whole window (just like OS);
                  </li>
                  <li><strong>Ajax Load</strong> - the hottest option allowing to load/reload widget
                    content asynchronously. You just need to provide an url to fetch the data
                    from. With loader delivered.
                  </li>
                </ul>
                <p>`In the future this plugin may be released under MIT license, but for now
                  its available exclusively with Light Blue.`
                </p>
                <p>
                  Test it out!
                </p>
            ...
            >
              <div>
                ...
                <p className="lead text-muted text-center">
                  Faith makes it possible to achieve that which man&apos;s mind can
                ...
                <Form>
                  ...
                  <p>
                    ...
                    value. If set, for example, to 2000 will refresh widget every 2 seconds.
                  </p>
          ...
          <Col xl={12} className="widget-container">
            ...
            >
              <div className="widget-body">
                <blockquote>
                  There are no limits. There are plateaus, but you must not stay there, you must
