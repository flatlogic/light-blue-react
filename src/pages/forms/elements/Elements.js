  ...
  render() {
    return (
      <div className={s.root}>
        <h2 className="page-title">Form Elements <small>Inputs, controls and more</small>
        </h2>
            ...
            <Widget title={<h5> <i className="fa fa-align-left" /> Inputs </h5>} settings refresh close>
              <FormGroup>
                <Form>
                  ...
                  <FormGroup row>
                    <Label md={4} for="transparent-field" className="text-md-right">Transparent input</Label>
                    <Col md={7}>
                      <Input type="text" id="transparent-field" className="input-transparent" placeholder="Stylish, huh??" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <Input type="text" className="input-transparent" name="password" id="hint-field" />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Label md={4} for="tooltip-enabled" className="text-md-right">Tooltip
                      enabled</Label>
                    <Col md={7}>
                      <Input type="text" id="tooltip-enabled" className="input-transparent" placeholder="Hover over me.." />
                  ...
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <Input
                        type="text" id="disabled-input" className="input-transparent"
                  ...
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <Input
                        type="text" id="max-length" className="input-transparent"
                        maxLength="3" placeholder="Max length 3 characters"
                      />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                  ...
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <InputGroup>
                        ...
                        <Input
                          id="password-field" className="input-transparent"
                  ...
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <InputGroup>
                        <Input id="appended-input" className="input-transparent" size="16" type="text" />
                  ...
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <InputGroup>
                        ...
                        <Input id="combined-input" className="input-transparent" size="16" type="text" />
                        <InputGroupAddon>.00</InputGroupAddon>
                      </InputGroup>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    ...
                    <Col md={7}>
                      <InputGroup className="input-group-transparent">
                        <Input id="transparent-input" className="input-transparent" type="text" />
          ...
          <Col lg={4}>
            ...
            >
              <Form>
                ...
                <FormGroup>
                  <InputGroup>
                    <InputGroupAddon className="bg-gray-lighter text-gray-dark">
                ...
                <FormGroup>
                  <InputGroup size="lg">
                    ...
                    <Input type="text" className="input-transparent" placeholder="Username" size="16" />
                  </InputGroup>
                </FormGroup>
                <FormGroup>
                  <InputGroup size="sm">
