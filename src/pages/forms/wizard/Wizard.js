...
const StepsComponents = {
  Step1: function Step1({ values, onValueChange }) {
    return (<fieldset>
      <FormGroup>
  ...
  Step2: function Step2({ values, onValueChange }) {
    return (
      <fieldset>
        <FormGroup>
          ...
          >
            ...
            <div className="tab-content">
              <div className={s.stepBody}>
                <Form>
                  {currentStep === 1 && <StepsComponents.Step1 values={values} onValueChange={handleValueChange} />}
